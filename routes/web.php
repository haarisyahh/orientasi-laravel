...
Route::post('/penyelia/change-password', [PenyeliaController::class, 'changePassword'])->name('penyelia.change-password');
...
Route::post('/admin/add-admin', [AdminController::class, 'addAdmin'])->name('admin.add-admin');
...
Route::get('/admin/staff-progress/export-csv', [AdminController::class, 'staffProgressExportCsv'])->name('admin.staff-progress.export-csv');
Route::get('/admin/staff-progress/certificate/{staffId}', [AdminController::class, 'adminCertificate'])->name('admin.staff-progress.certificate')->where('staffId', '[0-9]+');
...
Route::post('/admin/pengurusan-penyelia/reset-password', [AdminController::class, 'pengurusanPenyeliaResetPassword'])->name('admin.pengurusan-penyelia.reset-password');
Route::get('/admin/pengurusan-admin', [AdminController::class, 'pengurusanAdmin'])->name('admin.pengurusan-admin');
Route::post('/admin/pengurusan-admin/edit-user', [AdminController::class, 'adminUpdate'])->name('admin.pengurusan-admin.edit-user');
Route::post('/admin/pengurusan-admin/delete-user', [AdminController::class, 'adminDelete'])->name('admin.pengurusan-admin.delete-user');
Route::post('/admin/pengurusan-admin/reset-password', [AdminController::class, 'adminResetPassword'])->name('admin.pengurusan-admin.reset-password');
Route::post('/admin/pengurusan-admin/promote-super', [AdminController::class, 'adminPromoteSuper'])->name('admin.pengurusan-admin.promote-super');
Route::post('/admin/pengurusan-admin/remove-super', [AdminController::class, 'adminRemoveSuper'])->name('admin.pengurusan-admin.remove-super');
