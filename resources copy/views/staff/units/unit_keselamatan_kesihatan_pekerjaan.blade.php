...
@elseif($isUkkpVideoSlide)
  <div class="video-title">{{ $ukkpVideoTitle }}</div>
  <div class="video-wrapper" id="slideImage">
    <video class="video-frame" controls playsinline controlsList="nodownload noplaybackrate noremoteplayback">
      <source src="{{ asset($ukkpVideoFile) }}" type="video/mp4">
