...
<body>
    ...
    <main class="unit-main">
      <div class="slide-container">
        @php
          ...
          $isSumberManusiaUnit = $unitSlug === 'unit_sumber_manusia';
          ...
          $sumberManusiaVideoSlides = [
            17 => [
              'file' => 'assets/slide_images/sumber manusia/VIDEO TUTORIAL PERISYTIHARAN HARTA.mp4',
              'title' => 'VIDEO TUTORIAL PERISYTIHARAN HARTA',
            ],
            18 => [
              'file' => 'assets/slide_images/sumber manusia/VIDEO TUTORIAL SEMAKAN DATA DAN KEMASKINI REKOD PERIBADI.mp4',
              'title' => 'VIDEO TUTORIAL SEMAKAN DATA DAN KEMASKINI REKOD PERIBADI',
            ],
          ];
          $ukkpVideoSlides = [
            41 => 'assets/slide_images/ukkp/Promosi SOP Pengendalian Alatan Tajam Dan Prosedur Pengambilan Darah UKKP HRPZ II.mp4',
          ];
          $isSumberManusiaVideoSlide = $isSumberManusiaUnit && array_key_exists($currentSlide, $sumberManusiaVideoSlides);
          ...
          $sumberManusiaVideoFile = $isSumberManusiaVideoSlide ? $sumberManusiaVideoSlides[$currentSlide]['file'] : null;
          $sumberManusiaVideoTitle = $isSumberManusiaVideoSlide ? $sumberManusiaVideoSlides[$currentSlide]['title'] : null;
          ...
          <div class="slide-controls">
            ...
            <div class="slide-nav">
              ...
              @if($currentSlide < $totalSlides)
                ...
                @elseif($isRekodVideoSlide || $isUkkpVideoSlide || $isSumberManusiaVideoSlide)
  ...
  <script>
    (function(){
      ...
      const isSumberManusiaUnit = slug === 'unit_sumber_manusia';
      const isRekodPerubatanUnit = slug === 'unit_rekod_perubatan';
      const isUkkpUnit = slug === 'unit_keselamatan_kesihatan_pekerjaan';
      const sumberManusiaVideoSlides = [17, 18];
      const isSumberManusiaVideoSlide = isSumberManusiaUnit && sumberManusiaVideoSlides.includes(currentSlide);
      ...
      const isVideoSlide = isSumberManusiaVideoSlide || isRekodVideoSlide || isUkkpVideoSlide;
